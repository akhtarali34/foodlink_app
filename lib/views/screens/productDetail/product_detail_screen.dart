                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                          ...
                          itemCount: widget.productData['storeImage'].length,
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    widget.productData['category'] == 'Chicken Karahi' ||
                            widget.productData['category'] == 'Chicken Karahi'
                        ? ExpansionTile(
                            title: Text(
                              'VARIATION AVAILABLE',
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: _cartProvider.getCartItem
                      ...
                      ? null
                      : () {
                          if (widget.productData['category'] != 'Chicken Karahi') {
                            print('id check if');
                            ...
                            if (_selectedSize == null) {
                              ...
                              print('id check else=============[[[');
                              print(   widget.productData['quantity']);
                              print(widget.productData['productName']);
                              print(widget.productData['storeImage'],);
                              print(widget.productData['quantity']);
                              print(widget.productData['productPrice'],);
                              print(widget.productData['vendorId']);
                              print(widget.productData['scheduleDate']);
