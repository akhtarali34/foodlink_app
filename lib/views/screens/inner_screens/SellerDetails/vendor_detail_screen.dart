...
import 'package:foodlink/views/screens/productDetail/vendor_store_detail_screen.dart';
import 'package:foodlink/views/screens/widgets/inner_chat_screen.dart';
...
class VendorDetailScreen extends ConsumerStatefulWidget {
  ...
  VendorDetailScreen({super.key, required this.sellerData});

  @override
  _ProductDetailScreenState createState() => _ProductDetailScreenState();
}

class _ProductDetailScreenState extends ConsumerState<VendorDetailScreen> {
  ...
  final String phoneNumber = '+923466467948';
  final String message = 'Hello from foodshef!';
  ...
  Widget build(BuildContext context) {
    ...
    final _cartProvider = pd.Provider.of<CartProvider>(context);
    ...
    LatLng vendorLatLng =
    LatLng(widget.sellerData['latitude'], widget.sellerData['longitude']);
    return Scaffold(
        appBar: AppBar(
          elevation: 0,
          ...
          child: Column(
            ...
            children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                          ...
                          itemCount: widget.sellerData['storeImage'].length,
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '\$' +
                          widget.sellerData['productPrice'].toStringAsFixed(3),
                      style: TextStyle(
                        fontSize: 20,
                        fontWeight: FontWeight.bold,
                    ...
                    widget.sellerData['category'] == 'Chicken Karahi' ||
                        widget.sellerData['category'] == 'Chicken Karahi'
                        ? ExpansionTile(
                      title: Text(
                        'VARIATION AVAILABLE',
                      ...
                      children: [
                        Container(
                          ...
                          child: ListView.builder(
                              scrollDirection: Axis.horizontal,
                              itemCount:
                              widget.sellerData['sizeList'].length,
                              itemBuilder: (context, index) {
                                return Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Container(
                                    color: _selectedSize ==
                                        widget.sellerData['sizeList']
                                        [index]
                                        ? AppColors.mainColor
                                        : null,
              ...
              ListTile(
                ...
                title: Text(
                  widget.sellerData['bussinessName'].toUpperCase(),
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 17,
                  ),
              ...
              StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    ...
                    .where('productId',
                    isEqualTo: widget.sellerData['productId'])
                    .snapshots(),
                  ...
                  child: GoogleMap(
                    ...
                    markers: Set<Marker>.from([
                      Marker(
                        ...
                        position: LatLng(widget.sellerData['latitude'],
                            widget.sellerData['longitude']),
                    ...
                    initialCameraPosition: CameraPosition(
                        zoom: 14,
                        target: LatLng(widget.sellerData['latitude'],
                            widget.sellerData['longitude'])),
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: _cartProvider.getCartItem
                      .containsKey(widget.sellerData['productId'])
                      ? null
                      : () {
                    if (widget.sellerData['category'] != 'Chicken Karahi') {
                      print('id check if');
                      print(   widget.sellerData['productId']);
                      _cartProvider.addProductToCart(
                          widget.sellerData['productName'],
                          widget.sellerData['productId'],
                          widget.sellerData['storeImage'],
                          1,
                          widget.sellerData['quantity'],
                          widget.sellerData['productPrice'],
                          widget.sellerData['vendorId'],
                          '',
                          widget.sellerData['scheduleDate']);

                      Get.snackbar(
                        'ITEM ADDED',
                        'You Added ${widget.sellerData['productName']} To Your Cart',
                      ...
                      if (_selectedSize == null) {
                        ...
                        print('id check else=============[[[');
                        print(   widget.sellerData['quantity']);
                        print(widget.sellerData['productName']);
                        print(widget.sellerData['storeImage'],);
                        print(widget.sellerData['quantity']);
                        print(widget.sellerData['productPrice'],);
                        print(widget.sellerData['vendorId']);
                        print(widget.sellerData['scheduleDate']);
                ...
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                    return InnerChatScreen(
                      sellerId: widget.sellerData['vendorId'],
                      buyerId: FirebaseAuth.instance.currentUser!.uid,
                      productId: widget.sellerData['productId'],
